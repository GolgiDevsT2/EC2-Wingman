...
public class Wingman_raiseOrangeCpuAlarm_rspArg implements Parcelable
{
    ...
    public static final Parcelable.Creator<Wingman_raiseOrangeCpuAlarm_rspArg> CREATOR = new Parcelable.Creator<Wingman_raiseOrangeCpuAlarm_rspArg>() {
        public Wingman_raiseOrangeCpuAlarm_rspArg createFromParcel(Parcel in) {
            return new Wingman_raiseOrangeCpuAlarm_rspArg(in);
        }
        public Wingman_raiseOrangeCpuAlarm_rspArg[] newArray(int size) {
            return new Wingman_raiseOrangeCpuAlarm_rspArg[size];
        }
    };
    private Wingman_raiseOrangeCpuAlarm_rspArg(Parcel in) {
        this(in.readString());
    }
    ...
    public Wingman_raiseOrangeCpuAlarm_rspArg(){
        this(true);
    }

    public Wingman_raiseOrangeCpuAlarm_rspArg(boolean isSetDefault){
        super();
    ...
    public Wingman_raiseOrangeCpuAlarm_rspArg(GolgiPayload payload){
        this(false);
        deserialise(payload);
    }

    public Wingman_raiseOrangeCpuAlarm_rspArg(String payload){
