...
public class Wingman_raiseStatusCheckAlarm_rspArg implements Parcelable
{
    ...
    public static final Parcelable.Creator<Wingman_raiseStatusCheckAlarm_rspArg> CREATOR = new Parcelable.Creator<Wingman_raiseStatusCheckAlarm_rspArg>() {
        public Wingman_raiseStatusCheckAlarm_rspArg createFromParcel(Parcel in) {
            return new Wingman_raiseStatusCheckAlarm_rspArg(in);
        }
        public Wingman_raiseStatusCheckAlarm_rspArg[] newArray(int size) {
            return new Wingman_raiseStatusCheckAlarm_rspArg[size];
        }
    };
    private Wingman_raiseStatusCheckAlarm_rspArg(Parcel in) {
        this(in.readString());
    }
    ...
    public Wingman_raiseStatusCheckAlarm_rspArg(){
        this(true);
    }

    public Wingman_raiseStatusCheckAlarm_rspArg(boolean isSetDefault){
        super();
    ...
    public Wingman_raiseStatusCheckAlarm_rspArg(GolgiPayload payload){
        this(false);
        deserialise(payload);
    }

    public Wingman_raiseStatusCheckAlarm_rspArg(String payload){
