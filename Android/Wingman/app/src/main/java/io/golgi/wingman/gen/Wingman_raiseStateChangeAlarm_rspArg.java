...
public class Wingman_raiseStateChangeAlarm_rspArg implements Parcelable
{
    ...
    public static final Parcelable.Creator<Wingman_raiseStateChangeAlarm_rspArg> CREATOR = new Parcelable.Creator<Wingman_raiseStateChangeAlarm_rspArg>() {
        public Wingman_raiseStateChangeAlarm_rspArg createFromParcel(Parcel in) {
            return new Wingman_raiseStateChangeAlarm_rspArg(in);
        }
        public Wingman_raiseStateChangeAlarm_rspArg[] newArray(int size) {
            return new Wingman_raiseStateChangeAlarm_rspArg[size];
        }
    };
    private Wingman_raiseStateChangeAlarm_rspArg(Parcel in) {
        this(in.readString());
    }
    ...
    public Wingman_raiseStateChangeAlarm_rspArg(){
        this(true);
    }

    public Wingman_raiseStateChangeAlarm_rspArg(boolean isSetDefault){
        super();
    ...
    public Wingman_raiseStateChangeAlarm_rspArg(GolgiPayload payload){
        this(false);
        deserialise(payload);
    }

    public Wingman_raiseStateChangeAlarm_rspArg(String payload){
